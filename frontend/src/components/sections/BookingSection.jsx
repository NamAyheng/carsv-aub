            ...
            <div className="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
              ...
              <form onSubmit={handleSubmit}>
                <div className="row g-3">
                  ...
                  <div className="col-12 col-sm-6">
                    <select className="form-select border-0" style={{ height: 55 }} defaultValue="">
                  ...
                  <div className="col-12 col-sm-6">
                    <input type="date" className="form-control border-0" placeholder="Service Date" style={{ height: 55 }} />
                  </div>
